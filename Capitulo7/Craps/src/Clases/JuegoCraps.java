...
public class JuegoCraps {
 ...
 public static void main(String[] args) {
        ...
        System.out.printf("DespuÃ©s del tiro 20: %d juegos\n", juegosGanados[21]);
        ...
        System.out.println("\nd) DuraciÃ³n promedio de un juego de Craps:");
        System.out.printf("%.2f\n", duracionPromedio);
        
        System.out.println("\ne) Â¿Las probabilidades de ganar mejoran con la duraciÃ³n del juego?");
        System.out.println("No, las probabilidades de ganar en Craps son siempre las mismas, independientemente de la duraciÃ³n del juego.");
    }
    ...
    public static int jugarCraps(Random random) {
        ...
        if (resultado == 7 || resultado == 11) {
            ...
            while (true) {
                ...
                if (sumaDados == punto) {
                    return tirada; // Juego ganado despuÃ©s del primer tiro
                } else if (sumaDados == 7) {
                    return tirada; // Juego perdido despuÃ©s del primer tiro
                }
            }
        }
    }
