...
public class AlmacenServicioImpl implements AlmacenServicio{
	...
	//sirve para indicar que este metodo se va a ejecutar cada vez que halla una nueva instancia de esta clase 
	@PostConstruct
	@Override
	public void iniciarAlmacenDeArchivos() {
		try {
			...
			throw new AlmacenExcepcion("Error al iniciaizar la ubicacion en el almacen de archivo");
		}
	...
	public String almacenarArchivo(MultipartFile archivo) {
		...
		if (archivo.isEmpty()) {
			throw new AlmacenExcepcion("No se puede almacenarun archivo vacio");
